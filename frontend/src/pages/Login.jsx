...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden font-['Inter'] bg-pb-bg">
      ...
      {/* Radial Lighting */}
      <div className="absolute top-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-pb-accent opacity-[0.05] blur-[100px] pointer-events-none"></div>
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="bg-pb-card border border-pb-border rounded-[24px] p-10 shadow-[0_20px_50px_rgba(0,0,0,0.35)] relative">
          <div className="flex items-center justify-center mb-8 pb-4 border-b border-pb-border-divider">
            <ShieldCheckIcon />
            <span className="text-pb-text font-semibold text-lg tracking-wide">Secure Login</span>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="text-xs font-semibold text-pb-accent-soft hover:text-pb-accent transition-colors">Forgot?</a>
              </div>
              <input
                type="password"
                value={password}
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-pb-text-muted">
            ...
            <Link to="/register" className="text-pb-accent hover:text-pb-accent-hover font-semibold transition-colors">
              Create one now
            </Link>
          </p>
        </div>
